...
def add_box( points, x, y, z, width, height, depth ):
    ...
    add_polygon( points, w, h, z, w, y, z, x, y, z )
    #back face
    add_polygon( points, w, y, d, w, h, d, x, h, d )
    add_polygon( points, x, h, d, x, y, d, w, y, d )
    #left face 
    add_polygon( points, x, y, d, x, h, d, x, h, z )
    add_polygon( points, x, h, z, x, y, z, x, y, d )
    #right face (replace x for w)
    add_polygon( points, w, y, z, w, h, z, w, h, d )
    add_polygon( points, w, h, d, w, y, d, w, y, z )
    #bottom face
    add_polygon( points, w, h, d, w, h, z, x, h, z )
    add_polygon( points, x, h, z, x, h, d, w, h, d )
    #top face (replace y for h)
    add_polygon( points, x, y, d, x, y, z, w, y, z )
