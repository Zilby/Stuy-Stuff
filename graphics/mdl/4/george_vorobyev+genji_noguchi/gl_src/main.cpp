...
int main() {
	...
	//MODEL TESTING, TODO
	Model::models["test"];
	Model::models["test"].addMesh("torus");
	Model::models["test"].addMesh("sphere");

	Model::models["test"].getMesh("torus")->genPrimTorus(5, 1);
	Model::models["test"].getMesh("sphere")->genPrimSphere(2);
