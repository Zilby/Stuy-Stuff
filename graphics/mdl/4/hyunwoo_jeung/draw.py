...
def draw_polygons( points, screen, color ):
    ...
    for n in range(len(points))[::3]:
        a = [points[n+1][m]-points[n][m] for m in range(3)]
        b = [points[n+2][m]-points[n][m] for m in range(3)]
        normal_vector = cross_product(a,b)
        if dot_product(normal_vector, v) > 0:
            draw_line(screen,points[n][0],points[n][1],points[n+1][0],points[n+1][1],color)
            draw_line(screen,points[n+1][0],points[n+1][1],points[n+2][0],points[n+2][1],color)
            draw_line(screen,points[n+2][0],points[n+2][1],points[n][0],points[n][1],color)
...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    while lat < lat_stop - 1:
        ...
        while longt < longt_stop-1:
            ...
            a = temp[index]
            b = temp[index+num_steps]
            c = temp[index+num_steps+1]
            d = temp[index+1]
            add_polygon( points,
                         a[0], a[1], a[2],
                         b[0], b[1], b[2],
