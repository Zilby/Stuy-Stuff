...
def draw_polygons( points, screen, color ):
    ...
    while p < len( points ) - 2:
        if find_normal_cosine(points[p], points[p+1], points[p+2]) < 0: 
...
def find_normal_cosine(p1, p2, p3):
    a_vector = [p2[i] - p1[i] for i in range(3)]
    b_vector = [p3[i] - p1[i] for i in range(3)]
    cross = [a_vector[1]*b_vector[2] - a_vector[2]*b_vector[1],
             a_vector[2]*b_vector[0] - a_vector[0]*b_vector[2],
             a_vector[0]*b_vector[1] - a_vector[1]*b_vector[0]]
    view_vector = [0,0,-1]
    return sum([cross[i]*view_vector[i] for i in range(3)])
