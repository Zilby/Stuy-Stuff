...
def add_box(poly,x,y,z,l,h,d):
    ...
    #front face
    add_polygon(poly, x,y,z, x,y-h,z,   x+l,y-h,z);
    add_polygon(poly, x,y,z, x+l,y-h,z, x+l,y,z);
    #back face
    add_polygon(poly, x,y-h,z-d, x,y,z-d, x+l,y-h,z-d);
    add_polygon(poly, x+l,y-h,z-d, x,y,z-d,  x+l,y,z-d);
    #top face
    add_polygon(poly, x,y,z-d, x,y,z,  x+l,y,z-d);
    add_polygon(poly, x+l,y,z-d, x,y,z,  x+l,y,z);
    #bottom face
    add_polygon(poly, x,y-h,z, x,y-h,z-d, x+l,y-h,z-d);
    add_polygon(poly, x,y-h,z, x+l,y-h,z-d, x+l,y-h,z);
    #left face
    add_polygon(poly, x,y,z,   x,y,z-d, x,y-h,z);
    add_polygon(poly, x,y-h,z, x,y,z-d, x,y-h,z-d);
    #right face
    add_polygon(poly,  x+l,y,z-d,  x+l,y,z,      x+l,y-h,z);
    add_polygon(poly,  x+l,y,z-d, x+l,y-h,z,  x+l,y-h,z-d);
      
#add_polygon( ) function
def add_polygon(poly, x,y,z,x1,y1,z1,x2,y2,z2): #adds for the polygons using triangles
...
def add_triPoint(poly, p1, p2, p3):
    try:
        add_polygon(poly, p1[0], p1[1], p1[2], p2[0], p2[1], p2[2], p3[0], p3[1], p3[2])
    except:
        pass
...
def draw_polygons(poly,  screen, color):
