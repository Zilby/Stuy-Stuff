...
def scanline_convert( screen, x0, y0, x1, y1, x2, y2 ):
    ...
    while (y < yt):
        ...
        draw_line( screen, leftx, y, rightx, y, colorq )
...
def draw_polygons( points, screen, color ):
    ...
    while p < len( points ) - 2:
        ...
        if calculate_dot( points, p ) >= 0:
            ...
            scanline_convert( screen, points[p][0], points[p][1], points[p+1][0], points[p+1][1], points[p+2][0], points[p+2][1] )
        p+= 3
