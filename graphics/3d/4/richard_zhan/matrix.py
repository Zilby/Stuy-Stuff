...
def generate_curve_coefs( p1, p2, p3, p4, t ):
    if t == "hermite":
        matx = [[p1[0],p3[0],p2[0]-p1[0],p4[0]-p3[0]]]
        matrix_mult(make_hermite(),matx)
        maty = [[p1[1],p3[1],p2[1]-p1[1],p4[1]-p3[1]]]
        matrix_mult(make_hermite(),maty)
        return [matx,maty]
    elif t == "bezier":
        matx = [[p1[0],p2[0],p3[0],p4[0]]]
        matrix_mult(make_bezier(),matx)
        maty = [[p1[1],p2[1],p3[1],p4[1]]]
        matrix_mult(make_bezier(),maty)
        return [matx,maty]
