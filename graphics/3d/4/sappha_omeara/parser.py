    ...
    while c  <  len(commands):
        ...
        if cmd in 'lstxyzcbhwpmd':
            ...
            if cmd == 'l':
                ...
                ##add box to edge matrix. takes (x, y, z, width, height, depth)
                pass
            
            elif cmd == 'm':
                ##add sphere to edge matrix. takes (x, y, radius)
                pass
            
            elif cmd == 'd':
                ##add torus to edge matrix. takes (x, y, radius1, radius2)
                ##radius1 is radius of circle, radius2 is radius of torus.
                pass
