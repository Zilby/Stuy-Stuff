    ...
    while c  <  len(commands):
        ...
        if cmd[0] == '#':
            ...
            if cmd == 'l':
                ...
                add_circle( points, args[0], args[1], 0, args[2], .0001 )
            
            elif cmd == 'b':
                add_curve( points, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], .0001, 'bezier' )

            elif cmd == 'h':
                add_curve( points, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], .0001, 'hermite' )
