    ...
    while c  <  len(commands):
        ...
        if cmd in 'lstxyzcbhmdp':
            ...
            if cmd == 'l':
                ...
                add_circle( points, args[0], args[1], args[2], args[3], .01 )
                ...
                add_torus( points, args[0],args[1],args[2],args[3],args[4], .01)
...
nyeh = []
oof = new_matrix()
parse_file ('replacement_c',nyeh,oof)
'''
'''
blah = []
meh = new_matrix()
parse_file ('tsurugi_c', blah, meh)
'''
blah = []
meh = new_matrix()

parse_file('test_script',blah,meh)

'''
parse_file ('test_c', blah, meh)

parse_file('oof_c', blah, meh)
'''
