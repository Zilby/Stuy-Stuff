    ...
    while c  <  len(commands):
        ...
        if cmd in 'lstxyzcbhpmd':
            ...
            if cmd == 'l':
                ...
                add_circle( points, args[0], args[1], 0, args[2], step )
            
            elif cmd == 'b':
                add_curve( points, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], step, 'bezier' )

            elif cmd == 'h':
                add_curve( points, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], step, 'hermite' )
...
#parse_file('script_cplusplus', points, transform)
parse_file('script_cminus', points, transform)
