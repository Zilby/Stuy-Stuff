...
def apply_transformations():
    resultant = []
    for x in pt_matrix:
        resultant.append(m_mult_pt(master, x))
...
if __name__ == "__main__":
    #add_edge(pt_matrix, 0, 0, 100, 100, random_color(), random_color())
    #add_edge(pt_matrix, 0, 100, 100, 0, random_color(), random_color())
    #add_edge(pt_matrix, 50, 0, 50, 0, random_color(), random_color())
    #add_edge(pt_matrix, 0, 50, 0, 50, random_color(), random_color())
    #add_edge(pt_matrix, 100, 0, 0, 100, random_color(), random_color())
    #add_edge(pt_matrix, 0, 0, 100, 0, random_color(), random_color())
    #add_edge(pt_matrix, 0, 0, 0, 100, random_color(), random_color())
    #add_edge(pt_matrix, 0, 100, 100, 100, random_color(), random_color())
    #add_edge(pt_matrix, 100, 0, 100, 100, random_color(), random_color())
