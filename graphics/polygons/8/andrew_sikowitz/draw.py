...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    generate_sphere( t, cx, cy, cz, r, step )
    ...
    while lat < lat_stop:
        ...
        while longt < longt_stop:
            ...
            p0 = t[index]
            p1 = t[index + num_steps]
            p2 = t[index + num_steps + 1]
            add_polygon(points, p0[0],p0[1],p0[2], p1[0],p1[1],p1[2], p2[0],p2[1],p2[2])
            add_polygon(points, p0[0],p0[1],p0[2], p2[0],p2[1],p2[2], p1[0],p1[1],p1[2])
