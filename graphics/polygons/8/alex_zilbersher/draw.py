...
def add_box( points, x, y, z, width, height, depth ):
    ...
    d = z - depth
    #front face
    add_polygon( points, x, y, z, w, y, z, w, h, z )
    add_polygon( points, x, y, z, w, h, z, x, h, z )
    #back face (replace z for d)
    add_polygon( points, x, y, d, w, y, d, w, h, d )
    add_polygon( points, x, y, d, w, h, d, x, h, d )
    #left face 
    add_polygon( points, x, y, z, x, h, z, x, h, d )
    add_polygon( points, x, y, z, x, h, d, x, y, d )
    #right face (replace x for w)
    add_polygon( points, w, y, z, w, h, z, w, h, d )
    add_polygon( points, w, y, z, w, h, d, w, y, d )
    #bottom face
    add_polygon( points, x, y, z, w, y, z, w, y, d )
    add_polygon( points, x, y, z, w, y, d, x, y, d )
    #top face (replace y for h)
    add_polygon( points, x, h, z, w, h, z, w, h, d )
    add_polygon( points, x, h, z, w, h, d, x, h, d ) 
