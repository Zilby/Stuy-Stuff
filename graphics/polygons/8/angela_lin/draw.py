...
def is_backface(x0, y0, z0, x1, y1, z1, x2, y2, z2):
    #point 0 is the common endpt.
    #two vectors
    ax = x1 - x0
    ay = y1 - y0
    az = z1 - z0
    ...
    nz = ax*by - ay*bx
    n = [nx, ny, nz]
    #general case, view vector. for our purposes, [0,0,-1]
    vx = 0
    vy = 0
    vz = -1
...
def draw_polygons( points, screen, color ):
    ...
    while p < (len(points) - 1):
        if is_backface(points[p][0], points[p][1], points[p][2], points[p+1][0], points[p+1][1], points[p+1][2],points[p+2][0], points[p+2][1], points[p+2][2]):
...
def add_sphere( points, cx, cy, cz, r, step ):
    ...
    while lat <= lat_stop:
        ...
        while longt < longt_stop:
            ...
            #print temp[index]
            #print temp[index + num_steps]
            #print temp[index + num_steps + 1]
