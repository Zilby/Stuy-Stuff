...
def add_triangle( points, x0, y0, z0, x1, y1, z1, x2, y2, z2 ):
...
def add_box( matrix, x, y, z, h, w, d, step ):
    add_triangle( matrix, x, y, z, x, y+h, z, x+w, y+h, z )
    add_triangle( matrix, x, y, z, x+w, y+h, z, x+w, y, z )
    add_triangle( matrix, x, y, z, x, y, z+d, x, y+h, z+d )
    add_triangle( matrix, x, y, z, x, y+h, z+d, x, y+h, z )
    add_triangle( matrix, x, y, z, x+w, y, z+d, x, y, z+d )
    add_triangle( matrix, x, y, z, x+w, y, z, x+w, y, z+d )
    add_triangle( matrix, x+w, y+h, z+d, x, y+h, z+d, x, y+h, z )
    add_triangle( matrix, x+w, y+h, z+d, x, y+h, z, x+w, y+h, z )
    add_triangle( matrix, x+w, y+h, z+d, x+w, y, z+d, x+w, y, z )
    add_triangle( matrix, x+w, y+h, z+d, x+w, y, z, x+w, y+h, z )
    add_triangle( matrix, x+w, y+h, z+d, x, y, z+d, x+w, y, z+d )
    add_triangle( matrix, x+w, y+h, z+d, x, y+h, z+d, x, y, z+d )
    return
...
def draw_faces( matrix, screen, color ):
    if len( matrix ) < 3:
        print "Need at least 3 points to draw a face"
    p = 0
    while p < len( matrix ) - 1:
        draw_line( screen, matrix[p][0], matrix[p][1],
                   matrix[p+1][0], matrix[p+1][1], color )
