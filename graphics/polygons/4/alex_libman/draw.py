...
def add_sphere(matrix, cx, cy, r, step):
    ...
    while j < 1.00001 - step:
        ...
        z3 = r * math.sin(math.pi * (k + step)) * math.sin(2 * math.pi * a)
        add_polygon(matrix, x1, y1, z1, x2, y2, z2, x3, y3, z3)
        j += step
