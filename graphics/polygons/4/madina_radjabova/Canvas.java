...
public class Canvas extends JPanel {
	...
	else if (mode == gui.SPHERE_MODE_M) {
	    tmpline.addSphereMesh(/*parameters*/);
	}

	else if (mode == gui.TORUS_MODE_M) {
	    tmpline.addTorusMesh(/*parameters*/);
	}

	else if (mode == gui.BOX_MODE_M) {
	    tmpline.addBoxFrame(/*parameters*/);
	}
