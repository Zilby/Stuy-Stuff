...
public class EdgeMatrix extends Matrix {
 ...
 public void addBox(double x, double y, double z, double w, double h, double d) {
	...
	addPolygon(x1, y, z, x, y, z, x1, y1, z);
	addPolygon(x, y, z1, x, y1, z1, x1, y1, z1);
	addPolygon(x1, y, z1, x, y, z1, x1, y1, z1);
	
	addPolygon(x,y,z1, x, y, z, x1, y, z);
	addPolygon(x1,y,z1,x,y,z1,x1,y,z);
	addPolygon(x,y1,z1, x, y1, z, x1, y1, z);
	addPolygon(x1,y1,z1,x,y1,z1,x1,y1,z);

	addPolygon(x1, y, z, x1, y1, z, x1, y1, z1);
	addPolygon(x1, y, z1, x1, y, z, x1, y1, z1);
	addPolygon(x, y, z, x, y1, z, x, y1, z1);
	addPolygon(x, y, z1, x, y, z, x, y1, z1);
    ...
    /*======== public void addCircle() ==========
      ...
      public void addCircle(double cx, double cy, double rx, double ry) {
       ...
       for(int t = step; t <= 100; t += step) { 
        ...
        addPolygon(x0, y0, 0, x, y, 0, x, y, 0);
        x0 = x;
        y0 = y;
      }
