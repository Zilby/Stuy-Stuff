 ...
 public void setColor( Color n ) {
   c = n;
    ...
    public void setDrawing(int x0, int y0, int x1, int y1, int x2, int y2, int rx, int ry, int mode) {
     switch(mode) {
      ...
      case gui.LINE_MODE:
        ...
        break;
      case gui.BOX_MODE:
        tmpline.addBox(x0,y0,0, x1-x0, y0-y1, x1-x0);
        break;
      case gui.TORUS_MODE:
        double largeRadius = distance(x0,y0,x1,y1);
        double smallRadius = distance(x1,y1,x2,y2);
        tmpline.addTorus(x0,y0, smallRadius, largeRadius);
        break;

      case gui.SPHERE_MODE:
        double r = distance(x0, y0, rx, ry);
        tmpline.addSphere(x0, y0, r);
        break;
      case gui.HERMITE_MODE: case gui.BEZIER_MODE:
    ...
    /*======== public void addCurve() ==========
      ...
      public void addBox(int x0, int y0, int z0, int w, int h, int d) {
        edges.addBox(x0, y0, z0, w, h, d);
      }
    ...
    /*======== public void addLine() ==========
      ...
      public void addLine(int x0, int y0, int z0, 
       ...
       edges.addPolygon(x0,y0,z0,x1,y1,z1, x1,y1,z1);
       this.update(this.getGraphics());
     }
