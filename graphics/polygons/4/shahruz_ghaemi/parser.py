    ...
    while c  <  len(commands):
        ...
        if cmd in 'lstxyzcbhpmd':
            ...
            if cmd == 'l':
                ...
                add_prism( points, args[0], args[1], args[2], args[3], args[4], args[5] )
            
            elif cmd == 'm':
                add_sphere( points, args[0], args[1], 0, args[2], .05 )
            
            elif cmd == 'd':
                add_torus( points, args[0], args[1], 0, args[2], args[3], .05 )
