...
def surface_normal( x0, y0, z0, x1, y1, z1, x2, y2, z2 ):
    A = [ x1-x0, y1-y0, z1-z0 ]
    B = [ x2-x0, y2-y0, z2-z0 ]
...
def draw_polygons( points, screen, color ):
    for x in xrange( 0, len( points ) - 2, 3 ):
        N = surface_normal( points[x][0], points[x][1], points[x][2], points[x+1][0], points[x+1][1], points[x+1][2], points[x+2][0], points[x+2][1], points[x+2][2] )
        V = [ 0, 0, -1]
        if N[0]*V[0] + N[1]*V[1] + N[2]*V[2] < 0:
            ...
            draw_line( screen, points[x+2][0], points[x+2][1], points[x][0], points[x][1], color )
        ...
        while longt < longt_stop:
            ...
            if lat == lat_stop - 1:
                 add_polygon( points,
                              ...
                              temp[longt][0],     temp[longt][1],     temp[longt][2],
                              temp[longt + 1][0], temp[longt + 1][1], temp[longt + 1][2] )
